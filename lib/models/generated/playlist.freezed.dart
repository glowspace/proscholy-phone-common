...
@Id(assignable: true) int get id;@Unique(onConflict: ConflictStrategy.fail) String get name; int get rank;@Backlink() ToMany<PlaylistRecord> get records;
...
@useResult
$Res call({
@Id(assignable: true) int id,@Unique(onConflict: ConflictStrategy.fail) String name, int rank,@Backlink() ToMany<PlaylistRecord> records
});
...
/// Create a copy of Playlist
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? rank = null,Object? records = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@Id(assignable: true)  int id, @Unique(onConflict: ConflictStrategy.fail)  String name,  int rank, @Backlink()  ToMany<PlaylistRecord> records)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Playlist() when $default != null:
return $default(_that.id,_that.name,_that.rank,_that.records);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@Id(assignable: true)  int id, @Unique(onConflict: ConflictStrategy.fail)  String name,  int rank, @Backlink()  ToMany<PlaylistRecord> records)  $default,) {final _that = this;
switch (_that) {
case _Playlist():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@Id(assignable: true)  int id, @Unique(onConflict: ConflictStrategy.fail)  String name,  int rank, @Backlink()  ToMany<PlaylistRecord> records)?  $default,) {final _that = this;
switch (_that) {
case _Playlist() when $default != null:
return $default(_that.id,_that.name,_that.rank,_that.records);case _:
  return null;
...
class _Playlist extends Playlist {
  const _Playlist({@Id(assignable: true) required this.id, @Unique(onConflict: ConflictStrategy.fail) required this.name, required this.rank, @Backlink() required this.records}): super._();
  

@override@Id(assignable: true) final  int id;
@override@Unique(onConflict: ConflictStrategy.fail) final  String name;
@override final  int rank;
@override@Backlink() final  ToMany<PlaylistRecord> records;
...
/// Create a copy of Playlist
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? rank = null,Object? records = null,}) {
